...
export declare class DomainVerification extends pulumi.CustomResource {
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainVerificationState, opts?: pulumi.CustomResourceOptions): DomainVerification;
    /**
     ...
     */
    readonly lastVerifiedTime: pulumi.Output<string>;
    /**
     ...
     */
    readonly txtRecordName: pulumi.Output<string>;
    /**
