    ...
    construct: (name, type, urn) => {
        switch (type) {
            case "aws:cloudfront/anycastIpList:AnycastIpList":
                return new exports.AnycastIpList(name, undefined, { urn });
