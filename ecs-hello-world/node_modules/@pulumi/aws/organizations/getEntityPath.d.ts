 ...
 * ```
 */
export declare function getEntityPath(args: GetEntityPathArgs, opts?: pulumi.InvokeOptions): Promise<GetEntityPathResult>;
/**
 ...
 * ```
 */
export declare function getEntityPathOutput(args: GetEntityPathOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetEntityPathResult>;
/**
 * A collection of arguments for invoking getEntityPath.
 */
